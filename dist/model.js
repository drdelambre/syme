...
var _throttledObserver = require('./internal/throttled-observer.js');

var _throttledObserver2 = _interopRequireDefault(_throttledObserver);

var _magicArray = require('./internal/magic-array.js');

var _magicArray2 = _interopRequireDefault(_magicArray);

var _magicMethod = require('./internal/magic-method.js');

var _magicMethod2 = _interopRequireDefault(_magicMethod);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var blacklist = new RegExp('^(_.*|constructor|onUpdate|fill|out|errors|validate|extend|' + 'keys|toString|toLocaleString|valueOf|hasOwnProperty|' + 'isPrototypeOf|propertyIsEnumerable|should|before|clear)$');
...
var Model = function () {
    function Model(definition) {
        ...
        this._def = {};
        this._changeThrottle = new _throttledObserver2.default();
    ...
    (0, _createClass3.default)(Model, [{
        key: 'onUpdate',
        value: function onUpdate(field, callback) {
        ...
        value: function clear() {
            ...
            for (ni in this._def) {
                ...
                if (this._def[ni].value instanceof Model) {
                    this[ni].clear();
                } else if (TOSTR.call(no) === '[object Array]') {
                    this[ni] = new _magicArray2.default(this._def, ni, this._changeThrottle);
                } else {
                    this[ni] = no;
                }
            }
        ...
        value: function extend(def) {
            ...
            for (ni in def) {
                ...
                if (def[ni] instanceof Model || typeof def[ni] === 'function' && def[ni].prototype instanceof Model) {
                    this._def[ni] = {
                        'default': null,
                        value: new def[ni](),
                        type: def[ni],
                    ...
                    this._def[ni].value = new _magicArray2.default(this._def, ni, this._changeThrottle);
                } else {
                    this._def[ni] = {
                        'default': def[ni],
                        value: def[ni],
                ...
                (0, _magicMethod2.default)(this, this._def, ni, this._changeThrottle); // eslint-disable-line
            }
        ...
        value: function before(def) {
            ...
            for (ni in def) {
                if (!this._def.hasOwnProperty(ni)) {
                    throw new Error('Model: called before on a property (' + ni + ') that does not exist');
                }
