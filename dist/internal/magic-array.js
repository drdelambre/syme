...
\**/
function MagicArray(def, param, throttle) {
...
MagicArray.prototype.push = function () {
...
MagicArray.prototype.unshift = function () {
    var old = this.slice(0),
        ni,
        out;
...
MagicArray.prototype.splice = function () {
    var old = this.slice(0),
        ni;
...
MagicArray.prototype.concat = function () {
